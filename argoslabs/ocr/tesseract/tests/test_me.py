...
class TU(TestCase):
    ...
    def test0130_success_ocr(self):
        ...
        try:
            r = main('OCR', os.path.join(tdir, 'sample.png'), 'English',
                     '--outfile', outfile)
            self.assertTrue(r == 0)
            with open(outfile) as ifp:
                rs = ifp.read()
    ...
    def test0140_success_ocr(self):
        ...
        tdir = os.path.dirname(__file__)
        try:
            r = main('OCR', os.path.join(tdir, 'sample2.png'), 'English',
                     '--outfile', outfile)
            self.assertTrue(r == 0)
    ...
    def test0150_success_ocr(self):
        ...
        tdir = os.path.dirname(__file__)
        try:
            r = main('OCR', os.path.join(tdir, 'sample3.png'), 'English',
                     '--outfile', outfile)
            self.assertTrue(r == 0)
            with open(outfile) as ifp:
                rs = ifp.read()
    ...
    def test0160_success_jpn_01(self):
        ...
        tdir = os.path.dirname(__file__)
        try:
            r = main('OCR', os.path.join(tdir, 'jpn-01.png'), 'Japanese',
                     '--lang', 'Japanese',
                     '--outfile', outfile)
            self.assertTrue(r == 0)
            with open(outfile, encoding='utf-8') as ifp:
    ...
    def test0170_success_jpn_02(self):
        ...
        tdir = os.path.dirname(__file__)
        try:
            r = main('OCR', os.path.join(tdir, 'jpn-02.png'), 'Japanese',
                     '--lang', 'Japanese',
                     '--outfile', outfile)
            self.assertTrue(r == 0)
            with open(outfile, encoding='utf-8') as ifp:
    ...
    def test0180_success_kor_02(self):
        ...
        tdir = os.path.dirname(__file__)
        try:
            r = main('OCR', os.path.join(tdir, 'kor-02.png'), 'Korean',
                     '--lang', 'Korean',
                     '--outfile', outfile)
            self.assertTrue(r == 0)
            with open(outfile, encoding='utf-8') as ifp:
    ...
    def test0190_success_kor_01(self):
        ...
        tdir = os.path.dirname(__file__)
        try:
            r = main('OCR', os.path.join(tdir, 'kor-01.png'), 'Korean',
    ...
    def test0200_success_kor_03(self):
        ...
        tdir = os.path.dirname(__file__)
        try:
            r = main('OCR', os.path.join(tdir, 'kor-03.png'), 'Korean',
                     '--lang', 'Korean',
                     '--lang2', 'English',
