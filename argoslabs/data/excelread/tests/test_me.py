...
class TU(TestCase):
    ...
    def test0010_excelreplace_change_valueisnone(self):
        try:
            xls = r"C:\plugins\argoslabs\data\excelread\tests\text_excel_data.xlsx"
            r = main(xls,
                     '--sheet', 'Sheet3',
                     '--data-only'
                     )
    ...
    def test0020_CSV_Range_OneColumn(self):
        try:
            xls = r"C:\plugins\argoslabs\data\excelread\tests\text_excel.csv"
            r = main(xls,
                     '--range', '1:14'
                     )
            self.assertTrue(r == 0)
    ...
    def test0030_data_only(self):
        try:
            xls = r"C:\plugins\argoslabs\data\excelread\tests\arraytest1.xlsx"
            r = main(xls,
                     '--sheet', 'Sheet2',
                     # '--data-only'
                     )
    ...
    def test1200_xlsm(self):
        try:
            xls = r"C:\plugins\argoslabs\data\excelread\tests\arraytest1.xlsm"
            r = main(xls,
                     )
            self.assertTrue(r == 0)
        except Exception as e:
    ...
    def test1200_xlsm_kioxia(self):
        try:
            xls = r"C:\plugins\argoslabs\data\excelread\tests\Budget_Summary_App.xlsm"
            r = main(xls,
                     '--sheet', 'HOME'
                     )
            self.assertTrue(r == 0)
