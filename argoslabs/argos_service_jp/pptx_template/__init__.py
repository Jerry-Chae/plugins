...
class Operate_Template(object):
    ...
    def replace_img(self, i, img_path):
        ...
        image = self.prs.slides[0].shapes[i + 10]
...
def replace_object(mcxt, argspec):
    ...
    try:
        ...
        if argspec.text_01:
            OP.replace_text(0, argspec.text_01)
        else:
            pass

        if argspec.text_02:
            OP.replace_text(1, argspec.text_02)
        else:
            pass

        if argspec.text_03:
            OP.replace_text(2, argspec.text_03)
        else:
            pass

        if argspec.text_04:
            OP.replace_text(3, argspec.text_04)
        else:
            pass

        if argspec.text_05:
            OP.replace_text(4, argspec.text_05)
        else:
            pass

        if argspec.text_06:
            OP.replace_text(5, argspec.text_06)
        else:
            pass

        if argspec.text_07:
            OP.replace_text(6, argspec.text_07)
        else:
            pass

        if argspec.text_08:
            OP.replace_text(7, argspec.text_08)
        else:
            pass

        if argspec.text_09:
            OP.replace_text(8, argspec.text_09)
        else:
            pass

        if argspec.text_10:
            OP.replace_text(9, argspec.text_10)
        else:
            pass
        ...
        if argspec.img_01:
            if OP.img_path_check(argspec.img_01, argspec.img_exists) == 'ignore':
                ...
                OP.replace_img(0, argspec.img_01)
        else:
            pass
        ...
        if argspec.img_03:
            if OP.img_path_check(argspec.img_03, argspec.img_exists) == 'ignore':
                ...
                OP.replace_img(2, argspec.img_03)
        else:
            pass
        ...
        if argspec.img_04:
            if OP.img_path_check(argspec.img_04, argspec.img_exists) == 'ignore':
                ...
                OP.replace_img(3, argspec.img_04)
        else:
            pass
        ...
        if argspec.img_05:
            if OP.img_path_check(argspec.img_05, argspec.img_exists) == 'ignore':
                ...
                OP.replace_img(4, argspec.img_05)
        else:
            pass
        ...
        if argspec.img_06:
            if OP.img_path_check(argspec.img_06, argspec.img_exists) == 'ignore':
                ...
                OP.replace_img(5, argspec.img_06)
        else:
            pass
        ...
        if argspec.img_07:
            if OP.img_path_check(argspec.img_07, argspec.img_exists) == 'ignore':
                ...
                OP.replace_img(6, argspec.img_07)
        else:
            pass
        ...
        if argspec.img_08:
            if OP.img_path_check(argspec.img_08, argspec.img_exists) == 'ignore':
                ...
                OP.replace_img(7, argspec.img_08)
        else:
            pass
        ...
        if argspec.img_09:
            if OP.img_path_check(argspec.img_09, argspec.img_exists) == 'ignore':
                ...
                OP.replace_img(8, argspec.img_09)
        else:
            pass
        ...
        if argspec.img_10:
            if OP.img_path_check(argspec.img_10, argspec.img_exists) == 'ignore':
                ...
                OP.replace_img(9, argspec.img_10)
        else:
            pass
